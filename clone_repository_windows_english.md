# Clone the Workshop Repository (Windows)
...
Example: `C:\Users\YourUser\Documents\taller-otree`

💡 **Tip:** Avoid locations with:
- Spaces in folder names (prefer `my-project` over `my project`)
- Special characters like accents or symbols
- Synced folders like OneDrive or Dropbox (they can cause conflicts)

---

## Step 2: Open Git Bash in the correct location

**Option A: Open Git Bash directly in the folder (RECOMMENDED)**

1. Open **File Explorer**
2. Navigate to your **Documents** folder (or wherever you want to save the project)
3. **Right-click** inside the folder
4. Select **"Git Bash Here"** or **"Open Git Bash here"**
5. Git Bash will open directly in that location

**Option B: Navigate manually from Git Bash**

1. Open **Git Bash** (Windows key → type "Git Bash" → Enter)
...
## Step 3: (Optional) Create a specific folder for the workshop
...
Now let's clone! Run this command in **Git Bash**:
...
```
C:\Users\YourUser\Documents\taller-otree-pgg
```
