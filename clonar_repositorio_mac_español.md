# Clonar el repositorio del taller (macOS)
...
Ejemplo: `/Users/TuUsuario/Documents/taller-otree`
...
- Carpetas sincronizadas como iCloud Drive o Dropbox (pueden causar conflictos)
...
## Paso 3: Navegar a tu carpeta de Documentos
...
Presiona Enter. Esto te llevará a tu carpeta de Documentos.

---

## Paso 4: (Opcional) Crear una carpeta específica para el taller
...
Ahora sí, ¡vamos a clonar! Ejecuta este comando en **Terminal**:
...
## Paso 6: Entrar a la carpeta del proyecto
...
```
/Users/TuUsuario/Documents/taller-otree-pgg
```
